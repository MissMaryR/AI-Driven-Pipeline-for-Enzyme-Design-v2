...
# Under SLURM, $0 points to a spool copy (e.g. /var/spool/slurmd/job.../slurm_script),
# so dirname "$0" is useless for finding sibling scripts. Use SLURM_SUBMIT_DIR
# (the directory sbatch was invoked from) first, then $PWD, then dirname "$0".
AF3_SCRIPT=""
