...
| `af3_dir` | 4 (hardcoded) | Path to your AlphaFold3 installation — edit directly inside `4_AF3_bulk.py` |
...
> **Note:** The path to the AlphaFold3 installation (`af3_dir`) is hardcoded inside `4_AF3_bulk.py`. Edit the `af3_dir` variable near the top of that script before running.
